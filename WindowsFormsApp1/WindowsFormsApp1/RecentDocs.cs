    ...
    public class RecentDocs
    {
        public void run_script(string put)
        {
            ...
            Process p = new Process();
                ...
                p.StartInfo.WorkingDirectory = @"C:\Users\gslad\Documents\GitHub\Diplomski\Rezultati\RecentDocs";
                p.Start();
                p.WaitForExit();
                p.Close();
            ...
            {
                MessageBox.Show("Rezultati ove skripte su pohranjeni u: C:\\Users\\gslad\\Documents\\GitHub\\Diplomski\\Rezultati\\RecentDocs", "Rezultati");
            }
        }
